...
public class RestApiUtil {
    ...
    public String putPostString(String url, HttpHeaders headers, String requestBody, MediaType contentType, HttpMethod httpMethod) throws Exception {
    	...
    	logger.info("Request body string: "+shortenLog(requestBody));
        ...
        try {
            ...
            logger.info("Response body string: "+shortenLog(responseBody));
            return httpResponse.getBody();
        } catch (Exception e) {
            if (httpResponse!=null) {
            	logger.info("Error post to URL: "+url+" -- Request: "+requestBody+" -- Response status code: "+httpResponse.getStatusCode()+", response body: "+httpResponse.getBody());
                throw e;
            }
            logger.info("Error while API request to "+url+": "+e);
            throw e;
        }
    }
    ...
    public <T> T postObject(String url, HttpHeaders headers, Object requestObject, Class<T> responseObjectType) throws Exception {
        try {
        	...
        	logger.info("Error while post object: "+e);
            throw e;
        }
    }
    ...
    public <T> T postResponseObject(String url, HttpHeaders headers, Object requestObject, Class<T> cls) throws Exception {
        try {
        	...
        	logger.info("Error while get object: "+e);
            throw e;
        }
    }
    ...
    public <T> T putObject(String url, HttpHeaders headers, Object requestObject, Class<T> responseObjectType) throws Exception {
        try {
        	...
        	logger.info("Error while put object: "+e);
            throw e;
        }
    }
    ...
    public String getString(String srcUrl, HttpHeaders headers, Map<String,Object> queryStrings) throws Exception {
        ...
        try {
            ...
            if (httpResponse!=null) {
            	logger.info("Error GET to URL: "+url+" -- Response status code: "+httpResponse.getStatusCode()+" -- Response body: "+httpResponse.getBody());
                throw e;
            }
            logger.info("Error while API request to "+url+": "+e);
            throw e;
